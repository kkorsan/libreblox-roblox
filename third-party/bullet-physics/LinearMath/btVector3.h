...
/*
 MacOS/OSX (amd64/Aarch64) spesific issues
 https://github.com/bulletphysics/bullet3/issues/2418#issuecomment-546677728
 same issue occurs here, the fix is placed after ln. 25
 */
