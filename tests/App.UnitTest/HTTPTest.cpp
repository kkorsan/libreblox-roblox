...
{
	{
		// Make a synchronous get request expecting data
		{
			...
			RBX::Http b(guidify("http://www.roblox.com/Info/EULA.htm"), RBX::Http::Curl);
			RBX_TEST_WITH_TIMEOUT(boost::bind(&testGet, boost::ref(b), false), RBX::Time::Interval(10));
			RBX::Http c(guidify("http://www.roblox.com/Info/EULA.htm"), RBX::Http::Curl);
	...
	
		{
			...
			RBX::Http b(guidify("http://blahblah.roblox.com/this_should_fail.php"), RBX::Http::Curl);
			RBX_TEST_WITH_TIMEOUT(boost::bind(&testGetFailure, boost::ref(b), false), RBX::Time::Interval(10));
			RBX::Http c(guidify("http://blahblah.roblox.com/this_should_fail.php"), RBX::Http::Curl);
...
{
    {
        ...
        RBX::Http b("http://httpbin.org/get", RBX::Http::Curl);
        RBX_TEST_WITH_TIMEOUT(boost::bind(&testGet, boost::ref(b), true), RBX::Time::Interval(10));
        RBX::Http c("http://httpbin.org/get", RBX::Http::Curl);
...

    {
        ...
        RBX::Http b("http://httpbin.org/status/404", RBX::Http::Curl);
        RBX_TEST_WITH_TIMEOUT(boost::bind(&testGetFailure, boost::ref(b), true), RBX::Time::Interval(10));
        RBX::Http c("http://httpbin.org/status/404", RBX::Http::Curl);
...
{
    {
        ...
        RBX::Http b("http://httpbin.org/post", RBX::Http::Curl);
        RBX_TEST_WITH_TIMEOUT(boost::bind(&testPost, boost::ref(b)), RBX::Time::Interval(10));
        RBX::Http c("http://httpbin.org/post", RBX::Http::Curl);
