...
BOOST_AUTO_TEST_CASE(RemoteEvent)
{
	...
	{
		BOOST_TEST_MESSAGE("Test Client to Server");
	...
	{
		BOOST_TEST_MESSAGE("Test Server to Client");
	...
	{
		BOOST_TEST_MESSAGE("Test Client to Client2");
...
BOOST_AUTO_TEST_CASE(EventReplicator)
{
	...
	{
		BOOST_TEST_MESSAGE("Test Client not to Server");
