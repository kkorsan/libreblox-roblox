...
// SIMM include
#if !defined(__arm__) && !defined(__aarch64__)// ROBLOX
#include <xmmintrin.h>
#endif
...
#    elif defined(G3D_WIN32)
        ...
        default:
            arch = "Unknown";
                ...
                uintptr_t maxAddr = reinterpret_cast<uintptr_t>(systemInfo.lpMaximumApplicationAddress);
                {
                    char c[1024];
...
#elif (defined(RBX_PLATFORM_DURANGO) || defined(G3D_OSX) || defined(G3D_IOS) || defined(G3D_ANDROID) || defined(__arm__) || defined(__aarch64__)) && !defined(G3D_OSX_INTEL)
