...
#   endif
#   /* windows.h inclusion moved below so that it can be enabled for non-MSVC Windows toolchains (e.g., MinGW) */
#   /* WIN32_LEAN_AND_MEAN / NOMINMAX will be handled around that include. */

#   /* Winsock hide restoration moved below so that it happens after windows.h is included
     for all Windows toolchains (MSVC and MinGW). */
...
/* Ensure windows.h is included for MinGW and other non-MSVC Windows toolchains as well */
#ifdef G3D_WIN32
#   ifndef WIN32_LEAN_AND_MEAN
#       define WIN32_LEAN_AND_MEAN 1
#   endif
