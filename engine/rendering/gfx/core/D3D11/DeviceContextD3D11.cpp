...
namespace Graphics
{
        ...
        , d3d9(NULL)
    {
        ...
        if(PIX_ENABLED)
        {
            ...
            if (d3d9)
            {
                (void*&)pfn_D3DPERF_BeginEvent = (void*)GetProcAddress(d3d9, "D3DPERF_BeginEvent");
                (void*&)pfn_D3DPERF_EndEvent   = (void*)GetProcAddress(d3d9, "D3DPERF_EndEvent");
                (void*&)pfn_D3DPERF_SetMarker  = (void*)GetProcAddress(d3d9, "D3DPERF_SetMarker");
                (void*&)pfn_D3DPERF_GetStatus  = (void*)GetProcAddress(d3d9, "D3DPERF_GetStatus");
            }
        }
