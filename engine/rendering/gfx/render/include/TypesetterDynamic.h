...
namespace RBX
{
	namespace Graphics
	{
		...
		{
		public:
			TypesetterDynamic(TextureAtlas* textureAtlas, RBX::Graphics::TextureManager* textureManager, const std::string& fontPath, float legacyHeightScale, unsigned fontId, float viewScale);
            ...
            void setRetinaScale(float scale) { retinaScale = scale; }
