...
public:
    ...
    FrameRateCap getFrameRateCap() const { return frameRateCap; }
	...
	float getMaxFrameRate() const { 
        switch(frameRateCap) {
            case FrameRateCap_30: return 30.0f;
            case FrameRateCap_60: return 60.0f;
            case FrameRateCap_120: return 120.0f;
            case FrameRateCap_144: return 144.0f;
            case FrameRateCap_165: return 165.0f;
            case FrameRateCap_240: return 240.0f;
            case FrameRateCap_None: 
            case FrameRateCap_VSync:
                return 10000.0f; 
            default:
                return 60.0f;
        }
