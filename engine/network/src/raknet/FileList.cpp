#include "FileList.h"
    ...
    #include <io.h>
#elif defined(__arm__) || defined(__aarch64__) || defined(__APPLE__) || defined(__FreeBSD__)
    // ARM and BSD-based systems do not use or need sys/io.h for file operations
#else
    // Legacy x86 Linux paths
    #include <sys/io.h>
#endif
