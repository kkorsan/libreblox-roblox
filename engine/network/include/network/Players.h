...
namespace Network {
	...
	class Players
		: public DescribedCreatable<Players, Instance, sPlayers, Reflection::ClassDescriptor::PERSISTENT_HIDDEN>
		, public Service
	{
	private:
		typedef DescribedCreatable<Players, Instance, sPlayers, Reflection::ClassDescriptor::PERSISTENT_HIDDEN> Super;
	public:
