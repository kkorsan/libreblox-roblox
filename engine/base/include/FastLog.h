...
#pragma warning ( error : 4002 )
	...
	typedef void(*VariableVisitorEx)(const std::string& name, const std::string& value, FastVarType type, VariableKind kind, void* context);
	void LOGAPI ForEachVariable(VariableVisitorEx visitor, void* context, FastVarType flagType);
