...
public:
	...
	inline void validate() const
    {
		...
		RBXASSERT_VERY_FAST(
            // CRT debug allocator
            (uintptr_t)mPointer != 0xCCCCCCCC &&     // uninitialized stack memory
		    (uintptr_t)mPointer != 0xCDCDCDCD &&     // uninitialized heap memory
		    (uintptr_t)mPointer != 0xFDFDFDFD &&     // "no man's land" guard bytes before and after allocated heap memory
		    (uintptr_t)mPointer != 0xDDDDDDDD &&     // deleted heap memory
            (uintptr_t)mPointer != 0xFEEEFEEE &&     // deleted heap memory

            // Ogre allocator
            (uintptr_t)mPointer != 0xBAADF00D &&     // before "no man's land" guard bytes
            (uintptr_t)mPointer != 0xDEADC0DE &&     // after "no man's land" guard bytes
            (uintptr_t)mPointer != 0xFEEDFACE &&     // uninitialized memory
            (uintptr_t)mPointer != 0xDEADBEEF  );    // deleted memory
	}
