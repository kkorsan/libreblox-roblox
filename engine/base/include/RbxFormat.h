...
#ifdef _WIN32
    // Only use Microsoft-specific names if using the MSVC compiler
    #ifdef _MSC_VER
        #define snprintf _snprintf
        #define strcasecmp stricmp
    #else
        // MinGW/GCC already has snprintf and strcasecmp
        #include <string.h>
    #endif

    // MinGW needs these secure function aliases if they aren't provided
    #ifndef _MSC_VER
