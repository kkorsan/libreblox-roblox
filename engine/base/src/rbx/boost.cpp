...
#else
            // MinGW/GCC doesn't support SEH (__try/__except).
            // We just skip the debugger exception; the thread name is still
            // stored in the thread_specific_ptr via set_thread_name().
            (void)info;
#endif
			}
		}
