...
namespace RBX
{
	...
	public:
        ...
        // Clipboard callbacks
        typedef boost::function<std::string()> GetClipboardTextCallback;
        typedef boost::function<void(const std::string&)> SetClipboardTextCallback;
	...
	private:
        ...
        GetClipboardTextCallback getClipboardTextCallback;
        SetClipboardTextCallback setClipboardTextCallback;
    ...
    public:
		...
		bool isCtrlDown() { return isKeyDown(KC_LCTRL) || isKeyDown(KC_RCTRL); }
		bool isShiftDown() { return isKeyDown(KC_LSHIFT) || isKeyDown(KC_RSHIFT); }
		bool isAltDown() { return isKeyDown(KC_LALT) || isKeyDown(KC_RALT); }
        ...
        void setClipboardCallbacks(GetClipboardTextCallback getCb, SetClipboardTextCallback setCb);
