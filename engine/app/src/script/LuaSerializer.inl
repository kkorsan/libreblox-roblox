...
#include "../lua-5.1.4/lstring.h"
#include "../lua-5.1.4/lfunc.h"
#include "../lua-5.1.4/ldo.h"
#include "../lua-5.1.4/ldebug.h"

#include "../lua-5.1.4/lopcodes.h"
...
private:
    ...
    static Proto* readRoot(VectorStream& ss, lua_State* L, TString* source, unsigned int modkey)
    {
        ...
        for (unsigned int i = 0; i < stringCount; ++i)
        {
            ...
            strings[i] = luaS_newlstr(L, length > 0 ? &stringBuffer[0] : "", length);
        }
