...
RBX_REGISTER_ENUM(CRenderSettings::FrameRateCap);
...
namespace RBX
{
	namespace Reflection
	{
        ...
        template<> Reflection::EnumDesc<CRenderSettings::FrameRateCap>::EnumDesc()
            :Reflection::EnumDescriptor("FramerateCap")
        {
            addPair(CRenderSettings::FrameRateCap_Auto, "Automatic"); // 60
            addPair(CRenderSettings::FrameRateCap_VSync, "VSync"); // VSync ON
            addPair(CRenderSettings::FrameRateCap_30, "30 FPS");
            addPair(CRenderSettings::FrameRateCap_60, "60 FPS");
            addPair(CRenderSettings::FrameRateCap_120, "120 FPS");
            addPair(CRenderSettings::FrameRateCap_144, "144 FPS");
            addPair(CRenderSettings::FrameRateCap_165, "165 FPS");
            addPair(CRenderSettings::FrameRateCap_240, "240 FPS");
            addPair(CRenderSettings::FrameRateCap_None, "Uncapped");
        }
...
static Reflection::EnumPropDescriptor<CRenderSettingsItem, CRenderSettingsItem::FrameRateCap> prop_frameRateCap("FrameRateCap", "General", &CRenderSettingsItem::getFrameRateCap, &CRenderSettingsItem::setFrameRateCap);
...
void CRenderSettingsItem::setShowAggregation(bool value) {
	if (value!=showAggregation)
	{
        ...
        raisePropertyChanged(prop_ShowAggregation);
	}
}
...
void CRenderSettingsItem::setAASamples(AASamples value)
{
	if (value!=aaSamples)
	{
        ...
        raisePropertyChanged(prop_AASamples);
	}
}
...
void CRenderSettingsItem::setGraphicsMode(GraphicsMode value)
{
	if (value != graphicsMode) {
        ...
        raisePropertyChanged(prop_graphicsMode);
	}
}

void CRenderSettingsItem::setFrameRateCap(FrameRateCap value)
{
    if (value != frameRateCap) {
        frameRateCap = value;
        settingsChangedSignal(&prop_frameRateCap);
        raisePropertyChanged(prop_frameRateCap);
    }
}
...
{\
	if (value != modeVar##Mode) {\
        ...
        raisePropertyChanged(prop_##modeVar##Mode);\
	}\
}
...
void CRenderSettingsItem::setQualityLevel(QualityLevel value)
{
	if (value != qualityLevel) {
        ...
        raisePropertyChanged(prop_frmQuality);
	}
}
void CRenderSettingsItem::setEditQualityLevel(QualityLevel value)
{
	if (value != editQualityLevel) {
        ...
        raisePropertyChanged(prop_frmEditQuality);
	}
}
...
void CRenderSettingsItem::setDebugShowBoundingBoxes(bool value)
{
	if (value != debugShowBoundingBoxes) {
        ...
        raisePropertyChanged(prop_debugShowBoundingBoxes);
	}
}
...
void CRenderSettingsItem::setEnableFRM(bool value)
{
	if (value != enableFRM) {
        ...
        raisePropertyChanged(prop_enableFRM);
	}
}
...
#define SET_VAR_NOREG(T, boolName, boolVar, Category) \
	...
	{ \
		if (value != boolVar) { \
            ...
            raisePropertyChanged(prop_##boolVar); \
		} \
	}
