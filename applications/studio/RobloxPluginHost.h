...
private Q_SLOTS:
    ...
    void onCreateToolbar(long long toolbarID,QString name);
    void onCreateButton(long long toolbarID,long long actionID,QString text,QString tooltip,QString iconName);
	void onSetButtonActive(long long buttonID, bool active);
    void onShowToolbar(long long toolbarID,bool show);
    void onShowToolbars(QVariant toolbarID,bool show);
    void onEnableToolbar(long long toolbarID,bool enable);
	void setButtonIconInternal_deprecated(long long buttonId, QString iconName);
	void setButtonIconInternal(long long buttonId, QImage icon);
...
private:
    ...
    QString getToolbarName(long long id) const;
    ...
    QMap<long long,QToolBar*>             m_ToolBarMap;
    QMap<long long,QAction*>              m_ActionMap;
    QMap<long long,SARibbonPanel*>  m_RibbonGroupMap;

	SARibbonCategory*			    m_PluginsToolbar;
	SARibbonCategory*			    m_TerrainToolbar;       // Hack for terrain until these become native
    long long                             m_TerrainToolbarID;
	long long								m_TransformToolbarID;
	long long                             m_ConvertToSmoothID;
    QMap<QString,long long>               m_TextActionMap;

    static long long              		m_NextID;
};
