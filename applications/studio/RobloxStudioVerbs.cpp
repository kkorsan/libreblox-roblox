...
// Video recording support has been removed. Use external tools (e.g. OBS) to capture gameplay.
...
// Video recording implementation removed. Users should use external recording tools (e.g. OBS) for capturing gameplay.
