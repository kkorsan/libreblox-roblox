...
public:
	...
	void setFromJsonFuture(const std::shared_future<std::string>& jsonFuture);
...
private:
	...
	std::shared_future<std::string> jsonFuture;
...
private:
	...
	std::shared_future<void> publishIfThereAreLocalModifications(EntityProperties* settings);
