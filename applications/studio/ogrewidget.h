...
class QOgreWidget : public QWidget
{
	...
	public:
        ...
        class RobloxRenderWindow* renderWindow() const { return m_pRenderWindow; }
        ...
        // Public methods for RobloxRenderWindow to forward events
        void forwardMousePressEvent(QMouseEvent *evt);
        void forwardMouseReleaseEvent(QMouseEvent *evt);
        void forwardMouseMoveEvent(QMouseEvent *evt);
        void forwardKeyPressEvent(QKeyEvent *evt);
        void forwardKeyReleaseEvent(QKeyEvent *evt);
        void forwardWheelEvent(QWheelEvent *evt);
    ...
    private:
        ...
        class RobloxRenderWindow* m_pRenderWindow;
