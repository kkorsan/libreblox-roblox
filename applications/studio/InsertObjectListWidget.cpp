...
bool weightSorter(const InsertObjectListWidgetItem * a, const InsertObjectListWidgetItem * b)
{
    int wa = a->data(Qt::UserRole + 1).toInt();
    int wb = b->data(Qt::UserRole + 1).toInt();
    if (wa == wb)
