...
RBX::KeyCode getKeyCodeFromAndroidButtonInt(int androidKeycode)
{
	...
	{
		case 96: return RBX::KC_GAMEPAD_BUTTONA;
		case 97: return RBX::KC_GAMEPAD_BUTTONB;
		case 102: return RBX::KC_GAMEPAD_BUTTONL1;
		case 104: return RBX::KC_GAMEPAD_BUTTONL2;
		case 103: return RBX::KC_GAMEPAD_BUTTONR1;
		case 105: return RBX::KC_GAMEPAD_BUTTONR2;
		case 109: return RBX::KC_GAMEPAD_BUTTONSELECT;
		case 108: return RBX::KC_GAMEPAD_BUTTONSTART;
		case 106: return RBX::KC_GAMEPAD_BUTTONL3;
		case 107: return RBX::KC_GAMEPAD_BUTTONR3;
		case 99: return RBX::KC_GAMEPAD_BUTTONX;
		case 100: return RBX::KC_GAMEPAD_BUTTONY;
		case 20: return RBX::KC_GAMEPAD_DPADDOWN;
		case 21: return RBX::KC_GAMEPAD_DPADLEFT;
		case 22: return RBX::KC_GAMEPAD_DPADRIGHT;
		case 19: return RBX::KC_GAMEPAD_DPADUP;
...
void RobloxInput::handleGamepadAxisInput(int deviceId, int actionType, float newValueX, float newValueY, float newValueZ)
{
	...
	if (RBX::GamepadService* gamepadService = getGamepadService())
	{
		...
		if (rbxKeycode == RBX::KC_GAMEPAD_DPADUP ||
			rbxKeycode == RBX::KC_GAMEPAD_DPADDOWN ||
			rbxKeycode == RBX::KC_GAMEPAD_DPADRIGHT ||
			rbxKeycode == RBX::KC_GAMEPAD_DPADLEFT)
		{
			newValueZ =  fabs(newValueZ);
		}

		if (rbxKeycode == RBX::KC_GAMEPAD_BUTTONR2 || rbxKeycode == RBX::KC_GAMEPAD_BUTTONL2 ||
			rbxKeycode == RBX::KC_GAMEPAD_DPADUP ||
			rbxKeycode == RBX::KC_GAMEPAD_DPADDOWN ||
			rbxKeycode == RBX::KC_GAMEPAD_DPADRIGHT ||
			rbxKeycode == RBX::KC_GAMEPAD_DPADLEFT)
		{

			{
					...
					controllerBufferMap[gamepadEnum][rbxKeycode].back() != newValue)
				{
					...
					if (newValue.z == 0.0f)
					{
						if (rbxKeycode == RBX::KC_GAMEPAD_DPADUP)
						{
							controllerBufferMap[gamepadEnum][RBX::KC_GAMEPAD_DPADDOWN].push_back(newValue);
						}
						else if (rbxKeycode == RBX::KC_GAMEPAD_DPADRIGHT)
						{
							controllerBufferMap[gamepadEnum][RBX::KC_GAMEPAD_DPADLEFT].push_back(newValue);
						}
					}
				}
			}
        ...
        if (RBX::GamepadService* gamepadService = getGamepadService())
        {
	        ...
	        for (BufferedGamepadState::iterator iter = gamepadBufferState.begin(); iter != gamepadBufferState.end(); ++iter)
	        {
	            ...
	            for (std::vector<RBX::Vector3>::iterator vecIter = positions.begin(); vecIter != positions.end(); ++vecIter)
	            {
	                ...
	                {
	                	case RBX::KC_GAMEPAD_BUTTONR2:
	                    case RBX::KC_GAMEPAD_BUTTONL2:
	                    {
	                        if ((*vecIter).z >= 1.0f)
	                        {
	                    ...
	                    case RBX::KC_GAMEPAD_BUTTONA:
	                    case RBX::KC_GAMEPAD_BUTTONB:
	                    case RBX::KC_GAMEPAD_BUTTONX:
	                    case RBX::KC_GAMEPAD_BUTTONY:
	                    case RBX::KC_GAMEPAD_BUTTONR1:
	                    case RBX::KC_GAMEPAD_BUTTONL1:
	                    case RBX::KC_GAMEPAD_BUTTONR3:
	                    case RBX::KC_GAMEPAD_BUTTONL3:
	                    case RBX::KC_GAMEPAD_BUTTONSTART:
	                    case RBX::KC_GAMEPAD_DPADDOWN:
	                    case RBX::KC_GAMEPAD_DPADUP:
	                    case RBX::KC_GAMEPAD_DPADLEFT:
	                    case RBX::KC_GAMEPAD_DPADRIGHT:
	                    {
	                        isButton = true;
	                    ...
	                    case RBX::KC_GAMEPAD_THUMBSTICK1:
	                    case RBX::KC_GAMEPAD_THUMBSTICK2:
	                    {
